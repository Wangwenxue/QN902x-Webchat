...
// User configuration
// wenxue
#define UART0_QPPS_ENABLE  //ericyang20160215 add for uart0 and qpps profile
#ifdef UART0_QPPS_ENABLE
#define FIXED_BLE_WECHAT_HEADER   //ericyang20160222
#endif
//#define DEBUG_MSG_ENABLE   // ericyang20160223
#ifdef UART0_QPPS_ENABLE
typedef enum 
{
 	SRC_MESSAGE_NONE  = 0,
 	SRC_MESSAGE_WECHAT  = 1,
 	SRC_MESSAGE_QPPS = 2,
}msg_src_type;
#endif
...
#define CFG_LOCAL_NAME   "NXP WXPS"
...
#define CFG_PRF_DISS    // wenxue open
#define CFG_TASK_DISS   TASK_PRF1 // wenxue 2->1
...
///Heart Rate Profile Sensor Role
#define CFG_PRF_WXPS
#define CFG_TASK_WXPS   TASK_PRF2 // wenxue


#ifdef UART0_QPPS_ENABLE
#define CFG_PRF_QPPS
#define QPPS_NOTIFY_NUM     1//ericyang20160204  5
#define CFG_TASK_QPPS     TASK_PRF3
#endif
