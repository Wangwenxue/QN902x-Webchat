...
#ifdef UART0_QPPS_ENABLE  //ericyang20160216 // wenxue
...
int app_qpps_data_ind_handler(ke_msg_id_t const msgid,
                              ...
                              ke_task_id_t const src_id)
{
#ifdef UART0_QPPS_ENABLE  // ericyang 20160215
	msg_source = SRC_MESSAGE_QPPS;
	uart_write(QN_DEBUG_UART, param->data,param->length, NULL);//ericyang 20160204
#else
    if (param->length > 0)
    {
